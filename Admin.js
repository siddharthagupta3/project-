...
function getReply(text) {
  ...
  if (lowerText.match(/contact|email|phone|support|help|reach out|question/)) {
    return '📞 You can reach our support team via the Contact form below, or email us at support@cms.com. We\'re here 24/7!';
  }
  ...
  if (lowerText.match(/how are you|how's it going|how do you feel/)) {
    return '😄 I\'m doing great, thanks for asking! Ready to help you succeed with CMS!';
  }
