...
### Dashboard (dash.html)
- 📊 Home section with hero and image gallery
- 💬 Subscription form with typing animation
- 🎨 Colorful animated shapes grid
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/siddharthagupta3/interproject.git
   cd interproject
   ```
